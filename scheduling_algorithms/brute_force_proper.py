...
class BruteForce:
    ...
    def run(self):
        ...
        return len(worker_permutations), get_deployments_for_keys(deployments_map, best_possible_worker_arrangements), minimum_worker_subgraph_netcosts_list[best_possible_worker_arrangements[0]]
